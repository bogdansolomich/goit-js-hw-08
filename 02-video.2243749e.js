...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh=document.querySelector("#vimeo-player"),ep=new B(eh);console.log(localStorage),console.log(),ep.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function(e){// data is an object containing properties specific to that event
localStorage.setItem("videoplayer-current-time",e.seconds)},1e3));const ev=Number(localStorage.getItem("videoplayer-current-time"));console.log(ev),ep.setCurrentTime(ev).then(function(e){// seconds = the actual time that the player seeked to
}).catch(function(e){e.name});//# sourceMappingURL=02-video.2243749e.js.map

//# sourceMappingURL=02-video.2243749e.js.map
